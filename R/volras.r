...
#' @param maxpixels numeric value, how many pixels to be included in countour line. More pixels results in a more detailed output polygon, but slower calculation. 
#' 
#' @return
